...
class WorkoutCubit extends Cubit<WorkOutState> {
  ...
  void _applyFilters() {
    if (_currentBodyPart.toLowerCase() == 'all' && _currentDifficulty.toLowerCase() == 'all') {
    ...
    final filteredList = state.workOutListIntial?.where((workout) {
      bool matchesBodyPart = _currentBodyPart.toLowerCase() == 'all' || workout.bodyPart?.toLowerCase() == _currentBodyPart.toLowerCase();

      bool matchesDifficulty = _currentDifficulty.toLowerCase() == 'all' || workout.difficulty?.toLowerCase() == _currentDifficulty.toLowerCase();
